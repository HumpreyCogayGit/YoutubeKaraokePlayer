          ...
          {showSidebar && (
            <div className="lg:col-span-4 xl:col-span-3 flex flex-col gap-4 h-full overflow-y-auto">
              ...
              {!isAuthenticated && !isGuest && (
                <div className="flex-shrink-0 bg-gray-800 border border-gray-700 rounded-lg p-4">
                  <p className="text-gray-400 text-center">
                    <svg className="w-12 h-12 mx-auto mb-3 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                    </svg>
                    Sign in with Google to search and play songs
                  </p>
                </div>
              )}
              <div className="flex-shrink-0">
            ...
            {!isAuthenticated && !isGuest && (
              <div className="flex-1 bg-gray-800 rounded-lg flex items-center justify-center p-6">
                <div className="text-center max-w-lg">
                  ...
                  <h2 className="text-2xl font-bold text-white mb-2">Sign in to Play Videos</h2>
                  <p className="text-gray-400 mb-6">Sign in with your Google account to search and play karaoke songs</p>
                  <button
                    onClick={login}
                    className="flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-lg px-6 py-3 transition-all hover:scale-105 shadow-lg mx-auto"
                  >
                    <svg className="w-5 h-5" viewBox="0 0 24 24">
                      <path fill="white" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
                      <path fill="white" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
                  ...
                  <p className="text-gray-500 text-sm mt-6">You can still join parties as a guest without signing in</p>
                </div>
              </div>
            )}
